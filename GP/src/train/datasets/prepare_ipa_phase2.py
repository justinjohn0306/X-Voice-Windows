...
def read_all_metadata(input_dir):
    ...
    all_files = list(input_path.glob("metadata_zh*_top_1000.0h.csv"))
    csv_files = []
    for f in all_files:
        csv_files.append(f)
...
# python src/f5_tts/train/datasets/prepare_ipa_phase2.py --tokenizer ipa_v6 --dataset_name multilingual_sft