# 修改这里的配置
# bash src/x_voice/eval/eval_seedtts.sh
asr_gpu=8
task=zero_shot
...
python src/x_voice/eval/eval_seedtts_testset.py -e wer -l zh --gen_wav_dir ${decode_dir} --gpu_nums ${asr_gpu} --local
python src/x_voice/eval/eval_seedtts_testset.py -e sim -l zh --gen_wav_dir ${decode_dir} --gpu_nums ${asr_gpu} --local
python src/x_voice/eval/eval_utmos.py --audio_dir ${decode_dir}
