...
for lang in ${test_set}; do
    python src/x_voice/eval/eval_seedtts_testset.py -e wer -l ${lang} --gen_wav_dir ${decode_dir} --gpu_nums ${asr_gpu} --local
    python src/x_voice/eval/eval_seedtts_testset.py -e sim -l ${lang} --gen_wav_dir ${decode_dir} --gpu_nums ${asr_gpu} --local
    python src/x_voice/eval/eval_utmos.py --audio_dir ${decode_dir}/${lang}
done
